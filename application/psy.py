from psytest_tools import get_user_by_login, get_grades_by_psy, b64enc
...
def psy(sort_by='result'):
    ...
    return render_template('psy.html', logged=True, login=session['login'], count=cur_count, grades=grades, counters=counters, b64enc=b64enc)